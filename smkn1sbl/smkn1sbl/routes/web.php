...
Route::prefix('konsultasi')->name('pakar.consultation.')->group(function () {
    Route::get('/', [ConsultationController::class, 'create'])->name('create');
    Route::post('/', [ConsultationController::class, 'store'])->name('store');
    Route::get('/hasil/{consultation}', [ConsultationController::class, 'result'])->name('result');
});
...
Route::middleware(['auth'])->prefix('admin')->name('admin.')->group(function () {
    ...
    // ---- Sistem Pakar ----
    // Nonaktif sementara: view untuk modul ini (questions/knowledge-base/rules) belum dibuatkan.
    // Aktifkan lagi kalau viewnya sudah dibuat, kalau tidak akan error "View not found".
    ...
    //     Route::resource('knowledge-base', KnowledgeBaseController::class)->only(['index', 'store', 'update', 'destroy']);
    //     Route::resource('rules', RuleController::class)->only(['index', 'store', 'destroy']);
    //     Route::get('history', [ConsultationController::class, 'history'])->name('consultation.history');
    // });
